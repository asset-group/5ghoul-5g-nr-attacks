...
class stream_engine_base_t : public io_object_t, public i_engine
{
  ...
  protected:
    ...
    virtual int process_command_message (msg_t *msg_ __attribute__ ((unused)))
    {
        return -1;
    };
    virtual int produce_ping_message (msg_t *msg_ __attribute__ ((unused)))
    {
        return -1;
    };
    virtual int process_heartbeat_message (msg_t *msg_ __attribute__ ((unused)))
    {
        return -1;
    };
    virtual int produce_pong_message (msg_t *msg_ __attribute__ ((unused)))
    {
        return -1;
    };
